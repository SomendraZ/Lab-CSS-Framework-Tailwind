export default function App(){
  return(
    ...
    <div className="container mt-5  px-2">
      ...
      <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative my-5 ml-14" role="alert">
    ...
    <div className="justify-center flex p-6 bg-white ">
      ...
      <img src="https://s3.ap-south-1.amazonaws.com/kalvi-education.github.io/front-end-web-development/Kalvium-Logo.png" alt="" className="h-12 w-25" />
